...
* **api:** sync OpenAPI spec from production ([ec2272b](https://github.com/sentdm/sent-dm-python/commit/ec2272be8d8a34b79d518b51560b95ceda268dd0))
...
* **api:** repoint dangling model refs at current v3 schema names ([f99df44](https://github.com/sentdm/sent-dm-python/commit/f99df4488a15d18f8abcba0c0619d2760eb058ff))

## [0.36.0](https://github.com/sentdm/sent-dm-python/compare/v0.35.0...v0.36.0) (2026-09-06)


### Features

* **api:** sync OpenAPI spec from production ([7d21eca](https://github.com/sentdm/sent-dm-python/commit/7d21ecad32f3087b0360d157b79171412bac2d84))
* **api:** sync OpenAPI spec from production ([c128fe7](https://github.com/sentdm/sent-dm-python/commit/c128fe73e1a64063191a0b4ea97f9a89b1076366))
...
* **api:** manual updates ([44dfece](https://github.com/sentdm/sent-dm-python/commit/44dfece7b9d0c6f46330218c6f2726aed0ec14b4))
...
* **api:** manual updates ([3e3101a](https://github.com/sentdm/sent-dm-python/commit/3e3101addb74c439380e6e103fb854369f8d3a7f))

## 0.23.0 (2026-04-29)

Full Changelog: [v0.22.0...v0.23.0](https://github.com/sentdm/sent-dm-python/compare/v0.22.0...v0.23.0)

### Features

* **api:** api update ([5efacb8](https://github.com/sentdm/sent-dm-python/commit/5efacb8a7a7bf66d144c7f7e769c80cbe2433ac0))
...
* **api:** api update ([22f0812](https://github.com/sentdm/sent-dm-python/commit/22f0812b2c0a238b00b24e591d8b8ec5ccde4eb4))
...
* **api:** manual updates ([138c62e](https://github.com/sentdm/sent-dm-python/commit/138c62e490a20b0876e5a83d08cb05091285a11c))

## 0.10.0 (2026-03-11)

Full Changelog: [v0.9.0...v0.10.0](https://github.com/sentdm/sent-dm-python/compare/v0.9.0...v0.10.0)

### Features

* **api:** manual updates ([139fc97](https://github.com/sentdm/sent-dm-python/commit/139fc970739f191325548cf576906ded780ba10c))

## 0.9.0 (2026-03-11)

Full Changelog: [v0.8.1...v0.9.0](https://github.com/sentdm/sent-dm-python/compare/v0.8.1...v0.9.0)

### Features

* **api:** api update ([4047feb](https://github.com/sentdm/sent-dm-python/commit/4047febb44ed8aaf7fa8fc6dad948395d495defa))
