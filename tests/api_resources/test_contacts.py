...
class TestContacts:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_retrieve_message_summary(self, client: Sent) -> None:
        contact = client.contacts.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
        )
        assert_matches_type(ContactRetrieveMessageSummaryResponse, contact, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_retrieve_message_summary_with_all_params(self, client: Sent) -> None:
        contact = client.contacts.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
            x_profile_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve_message_summary(self, client: Sent) -> None:
        response = client.contacts.with_raw_response.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_message_summary(self, client: Sent) -> None:
        with client.contacts.with_streaming_response.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_retrieve_message_summary(self, client: Sent) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `contact_id` but received ''"):
            client.contacts.with_raw_response.retrieve_message_summary(
                contact_id="",
            )
...
class TestAsyncContacts:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_message_summary(self, async_client: AsyncSent) -> None:
        contact = await async_client.contacts.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
        )
        assert_matches_type(ContactRetrieveMessageSummaryResponse, contact, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_message_summary_with_all_params(self, async_client: AsyncSent) -> None:
        contact = await async_client.contacts.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
            x_profile_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_message_summary(self, async_client: AsyncSent) -> None:
        response = await async_client.contacts.with_raw_response.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_message_summary(self, async_client: AsyncSent) -> None:
        async with async_client.contacts.with_streaming_response.retrieve_message_summary(
            contact_id="6ba7b810-9dad-11d1-80b4-00c04fd430c8",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_retrieve_message_summary(self, async_client: AsyncSent) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `contact_id` but received ''"):
            await async_client.contacts.with_raw_response.retrieve_message_summary(
                contact_id="",
            )
