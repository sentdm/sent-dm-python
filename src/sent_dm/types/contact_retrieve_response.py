...
__all__ = ["ContactRetrieveResponse", "Data", "Error", "Meta"]
...
class Data(BaseModel):
    ...
    Contacts are no longer shared or inherited between sender profiles — a profile
    sees only the contacts it owns. Retained so existing v3 clients reading
    is_inherited keep deserializing; it carries no information.
    """
